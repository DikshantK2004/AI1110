...
\begin{enumerate}[label=(\alph*)]
    \item Let us define,
    \begin{align}
        F_{Z, X}(k , r) &= \pr{Z \le k , X =r}
    \end{align}

    Since , $Z = X + Y$,
    \begin{align}
        \label{a} F_{Z, X}(k , r) &=  F_{Y}(k -r)\pr{X = r}
    \end{align}
    ...
    \begin{align}
        &\pr{Z> 9 | X = 5} \\&= \frac{\pr{Z> 9, X = 5}}{\pr{X = 5}}\\
                          &= \frac{F_{Z ,X}(12 , 5) - F_{Z ,X}(9 , 5)}{\pr{X = 5}}\\
    ...
    \begin{align}
        \therefore \pr{Z> 9 | X = 5} = \frac{1}{3}\approx 0.33
    \end{align}
    
\item Let us define,

    \begin{align}
        F_{Z, Y}(k , r) &= \pr{Z = k , Y \le r}
    \end{align}

    Since , $Z = X + Y$,
    \begin{align}
        \label{b} F_{Z, Y}(k , r) &=  \sum_{i =1}^{r-1}\pr{Y = i }\pr{X = k - i}
    \end{align}

Using $\eqref{b}$
\begin{align}
\pr{Z = 8 | Y < 4} &= \frac{\pr{Z = 8, Y < 4}}{\pr{Y < 4}}\\
                       &= \frac{F_{Z, Y}(8 , 3)}{ F_{Y}(3)}\\
                       &= \frac{\brak{\frac{2}{36}}}{\frac{3}{6}}\\
                       &= \frac{1}{9} \approx 0.11   
\end{align}

\begin{align}
        \therefore \pr{Z = 8 | Y <  5} = \frac{1}{9}\approx 0.11
    \end{align}
\end{enumerate}
