...
The integral points (X,Y) in Fig\eqref{fig:1} in the blue shaded region(blue points) are the points satisfying 
$Y<4$. There are 18 such blue dots in blue shaded region out of $36$ possible pairs of $(X,Y)$.
...
The line represents X+Y = 8.
Therefore,the red dots which lie on both the line and inside the shaded region represent $X+Y = 8 ,Y < 4$
There are $2$ red dots out of $36$ possible pairs of $(X,Y)$
\begin{align}
    \pr{X+Y = 8, Y<4} &= \frac{2}{36}\\
    \therefore \pr{X+Y = 8 | Y < 4} &= \frac{1}{9} \approx
     0.11
\end{align}
