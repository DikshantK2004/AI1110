...
\begin{align}
\label{q} \pr{X+Y = 8 | Y < 4} &= \frac{\pr{X+Y = 8, Y < 4}}{\pr{Y < 4}}
\end{align}
...
Total number of $(X,Y)$ such that $0<X\le 6 , 0<Y\le 6$ is 36

In Fig\eqref{fig:1}, the blue region represent $Y < 4$ and the line is $X+Y = 8$, therefore red dots represent,
$X+Y = 8,Y < 4$
\begin{align}
