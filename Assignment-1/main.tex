...
\begin{align} \pr{r} = \comb{n}{r} p^{r}(1-p)^{n-r} \end{align}

Here, $p = \frac{1}{4}$ and $n = 5$.

% Part (i)
\begin{enumerate}[label=(\roman*)]
    \item Probability  that  all 5 cards are spades is \pr{5}.
\begin{align}
\pr{5} &= \comb{5}{5}\left(\frac{1}{4}\right)^{5} \left(\frac{3}{4}\right)^{0}\\
     &= \frac{1}{1024} \approx 0.00098
\end{align}

% Part (ii)
\item Probability that only 3 cards are spades is \pr{3}.
\begin{align}
\pr{3} &= \comb{5}{5} \left(\frac{1}{4}\right)^{3} \left(\frac{3}{4}\right)^{2}\\
     &= \frac{45}{512} \approx 0.08789
\end{align}

% Part (iii)
\item Probability that no card is spade is \pr{0}.
\begin{align}
\pr{0} &= \comb{5}{0} \left(\frac{1}{4}\right)^{0} \left(\frac{3}{4}\right)^{5}\\
