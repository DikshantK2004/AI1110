...
\begin{align} \label{eq:1} \pr{X=r} &= \comb{n}{r} p^{r}(1-p)^{n-r} \end{align}
...
\end{align}
\begin{align}
    X &\sim Bin\left(5 , \frac{1}{4}\right) \\
    \pr{r} &= \comb{5}{r} \left(\frac{1}{4}\right)^{r}
    \left(\frac{3}{4}\right)^{5-r} 
\end{align}
...
\begin{align}
\pr{X=5} &= \comb{5}{5}\left(\frac{1}{4}\right)^{5} \left(\frac{3}{4}\right)^{0}\\
...
\begin{align}
\pr{X=3} &= \comb{5}{5} \left(\frac{1}{4}\right)^{3} \left(\frac{3}{4}\right)^{2}\\
...
\begin{align}
\pr{X=0} &= \comb{5}{0} \left(\frac{1}{4}\right)^{0} \left(\frac{3}{4}\right)^{5}\\
